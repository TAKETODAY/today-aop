...
import cn.taketoday.aop.cglib.core.Converter;
...
abstract public class BeanCopier {
	...
	private static final Type CONVERTER = TypeUtils.parseType("cn.taketoday.aop.cglib.core.Converter");
	private static final Type BEAN_COPIER = TypeUtils.parseType("cn.taketoday.aop.cglib.beans.BeanCopier");
	private static final Signature COPY = new Signature("copy", Type.VOID_TYPE,
			new Type[] { Constant.TYPE_OBJECT, Constant.TYPE_OBJECT, CONVERTER });
	...
	public static class Generator extends AbstractClassGenerator {
		...
		public void generateClass(ClassVisitor v) {
			...
			ce.begin_class(Constant.V1_2, Constant.ACC_PUBLIC, getClassName(), BEAN_COPIER, null, Constant.SOURCE_FILE);
