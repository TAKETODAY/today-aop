...
class BeanMapEmitter extends ClassEmitter {
	private static final Type BEAN_MAP = TypeUtils.parseType("cn.taketoday.aop.cglib.beans.BeanMap");
	private static final Type FIXED_KEY_SET = TypeUtils.parseType("cn.taketoday.aop.cglib.beans.FixedKeySet");
	...
	public BeanMapEmitter(ClassVisitor v, String className, Class type, int require) {
		...
		begin_class(Constant.V1_2, Constant.ACC_PUBLIC, className, BEAN_MAP, null, Constant.SOURCE_FILE);
