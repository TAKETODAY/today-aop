...
class BulkBeanEmitter extends ClassEmitter {
    ...
    private static final Type BULK_BEAN = TypeUtils.parseType("cn.taketoday.aop.cglib.beans.BulkBean");
    private static final Type BULK_BEAN_EXCEPTION = TypeUtils.parseType("cn.taketoday.aop.cglib.beans.BulkBeanException");
    ...
    public BulkBeanEmitter(ClassVisitor v, String className, Class target, String[] getterNames, String[] setterNames,
        ...
        begin_class(Constant.V1_2, Constant.ACC_PUBLIC, className, BULK_BEAN, null, Constant.SOURCE_FILE);
