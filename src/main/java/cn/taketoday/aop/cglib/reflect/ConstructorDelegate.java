...
abstract public class ConstructorDelegate {
    ...
    public static class Generator extends AbstractClassGenerator {
        ...
        private static final Type CONSTRUCTOR_DELEGATE = TypeUtils.parseType("cn.taketoday.aop.cglib.reflect.ConstructorDelegate");
        ...
        public void generateClass(ClassVisitor v) {
            ...
            ce.begin_class(Constant.V1_2, Constant.ACC_PUBLIC, getClassName(), CONSTRUCTOR_DELEGATE,
                    new Type[]
