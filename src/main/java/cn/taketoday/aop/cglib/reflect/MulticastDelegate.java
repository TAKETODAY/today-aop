...
import cn.taketoday.aop.cglib.core.ProcessArrayCallback;
...
abstract public class MulticastDelegate implements Cloneable {
	...
	public static class Generator extends AbstractClassGenerator {
		...
		private static final Type MULTICAST_DELEGATE = TypeUtils
				.parseType("cn.taketoday.aop.cglib.reflect.MulticastDelegate");
		...
		public void generateClass(ClassVisitor cv) {
			...
			ce.begin_class(Constant.V1_2, Constant.ACC_PUBLIC, getClassName(), MULTICAST_DELEGATE,
					new Type[] { Type.getType(iface) }, Constant.SOURCE_FILE);
