...
class FastClassEmitter extends ClassEmitter {
    ...
    private static final Signature GET_SIGNATURE_WITHOUT_RETURN_TYPE = TypeUtils.parseSignature(
            "String getSignatureWithoutReturnType(String, Class[])");
    private static final Type FAST_CLASS = TypeUtils.parseType("cn.taketoday.aop.cglib.reflect.FastClass");
    ...
    public FastClassEmitter(ClassVisitor v, String className, Class type) {
        ...
        begin_class(Constant.V1_2, Constant.ACC_PUBLIC, className, FAST_CLASS, null, Constant.SOURCE_FILE);
