 ...
 * such as
 * <p>
 * <code>cn.taketoday.aop.cglib.Foo$$EnhancerByCGLIB$$38272841</code>
 * <p>
...
public class DefaultNamingPolicy implements NamingPolicy {
     ...
     */
    private final static boolean STRESS_HASH_CODE = Boolean.getBoolean("cn.taketoday.aop.cglib.test.stressHashCodes");

    public String getClassName(String prefix, String source, Object key, Predicate names) {

        if (prefix == null) {
            prefix = "cn.taketoday.aop.cglib.empty.Object";
        }
        else if (prefix.startsWith("java")) {
            prefix = "$" + prefix;
        }

        String base = prefix + "$$" + source.substring(source.lastIndexOf('.') + 1) + getTag() + "$$" + Integer.toHexString(STRESS_HASH_CODE
                ? 0 : key.hashCode());
