...
public abstract class ReflectUtils {
			...
			try {
				defineClass = (Method) AccessController.doPrivileged(new PrivilegedExceptionAction() {
					public Object run() throws Exception {
						...
						Method defineClass = loader.getDeclaredMethod("defineClass", new Class[] { String.class,
				...
				Class u = Class.forName("sun.misc.Unsafe");
				defineClassUnsafe = u.getMethod("defineClass", new Class[] { String.class, byte[].class, Integer.TYPE,
	...
	public static Class defineClass(String className, byte[] b, ClassLoader loader, ProtectionDomain protectionDomain)
		...
		if (DEFINE_CLASS != null) {
			...
			Object[] args = new Object[] { className, b, new Integer(0), new Integer(b.length), loader,
					protectionDomain };
