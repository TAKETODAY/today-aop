...
class LazyLoaderGenerator implements CallbackGenerator {
	...
	private static final Type LAZY_LOADER = TypeUtils.parseType("cn.taketoday.aop.cglib.proxy.LazyLoader");
	...
	private Signature loadMethod(int index) {
		return new Signature("CGLIB$LOAD_PRIVATE_" + index, Constant.TYPE_OBJECT, Constant.TYPES_EMPTY);
	}
