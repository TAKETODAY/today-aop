...
class DispatcherGenerator implements CallbackGenerator {
    ...
    private static final Type DISPATCHER = TypeUtils.parseType("cn.taketoday.aop.cglib.proxy.Dispatcher");
    private static final Type PROXY_REF_DISPATCHER = TypeUtils.parseType("cn.taketoday.aop.cglib.proxy.ProxyRefDispatcher");
