...
class InvocationHandlerGenerator implements CallbackGenerator {
    ...
    private static final Type INVOCATION_HANDLER = TypeUtils.parseType("cn.taketoday.aop.cglib.proxy.InvocationHandler");
    private static final Type UNDECLARED_THROWABLE_EXCEPTION = TypeUtils.parseType(
            "cn.taketoday.aop.cglib.proxy.UndeclaredThrowableException");
